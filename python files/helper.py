...
def labelCleaner(colString, keys):
...
def verticalSplit_test(df_list, dictonary, verbose = False):
    split_dfs = []
...
def volumeCleaner(dataFrame, key_words = "", stop_words = "", verbose = False):
...
def dateCleaner(dataFrame, key_words = "", stop_words = "", impute = False, verbose = False):
    dataFrame = dataFrame.rename(str.lower, axis = 'columns')
    #dataFrame = dataFrame.loc[:,~dataFrame.columns.duplicated()]
    if key_words == "":
...
def priceCleaner(dataFrame, key_words = "", stop_words = "", verbose = False):
...
def productCleaner(dataFrame, key_words = "", stop_words = "", impute = False, verbose = False):
    ...
    if key_words == "":
        ...
        units_helper = {'barrel' : 'oil', 'btu' : 'natural gas', 'bbl' : 'oil', 'gas': 'natural gas',
                        'ngl': 'natural gas liquid', 'mcf' : 'natural gas liquid'}
    if stop_words == "":
        stop_words = []
...
def instrumentCleaner(dataFrame, key_words = "", stop_words = "", impute = False, verbose = False):
    ...
    #dataFrame = dataFrame.loc[:, ~dataFrame.columns.duplicated()]
    if key_words == "":
        key_words = ['swap option', 'fixed-price swap', 'basis swap',
                     'two-way collar', 'three-way collar', 'two way collar',
                     'three way collar',
                     'put option', 'fixed price swap', 'floor', 'ceiling',
